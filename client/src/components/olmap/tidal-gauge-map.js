...
var tidalGaugeMap = function (target, options) {
  return {
    initMap: function () {
       ...
       */
      var DrawPointControl = (function (Control) {
        function DrawPointControl(opt_options) {
          var options = opt_options || {};

          var button = document.createElement('button');
          button.innerHTML = '<i class="material-icons">scatter_plot</i>';
        ...
        if ( Control ) DrawPointControl.__proto__ = Control;
        DrawPointControl.prototype =
          Object.create( Control && Control.prototype );
        DrawPointControl.prototype.constructor = DrawPointControl;

        DrawPointControl.prototype.handleDrawPolygon = (opts) => {
          startDrawInteraction();
        };

        return DrawPointControl;
      }(ol.control.Control));
